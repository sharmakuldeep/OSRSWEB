...
//                alert(" data " +data)       ;
                ...
                pie.Set('chart.labels', ['PrimarySchools', 'SecondarySchools', 'SeniorSecondarySchools', 'Colleges']);
...
//                alert( "data "+data) ;
                ...
                bar.Set('chart.labels', ['PrimarySchools', 'SecondarySchools', 'SeniorSecondarySchools', 'Colleges']);
...
//            }
   ...
   %{--<a href="#" onclick="$('#pop_up').attr('style', 'display:inline');" >Pie</a>--}%
    <input type="button" style= "width:30px;height:30px ;background-image:url(../images/temp/pie.jpg) "
           %{--name="Pie" value="Pie" /--}%
   <a href="#" onclick="$('#pop_up').attr('style', 'display:inline');" >Pie</a>
   %{--<a href="#" onclick="$('#aaa').attr('style', 'display:inline');" >Pie</a>--}%
    ...
    <input type="button" style="width:30px;height:30px ;background-image:url(../images/temp/bar.jpg) "
           %{--name="Bar" value="Bar"/--}%
    <a href="#" onclick="$('#pop_up1').attr('style', 'display:inline');" >Bar</a>
        <h1>
            %{--${data}--}%
        </h1>
