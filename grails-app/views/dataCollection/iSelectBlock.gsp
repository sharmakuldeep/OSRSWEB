...
<div id="content">
    ...
    <span class="graytitle">Select Block</span>

       <g:each in="${blocks}" var="block">
           <ul class="pageitem">
        <li class="store" style="height: 50px;">
            <g:link class="nodffect" action="iSelectVillage"  params="[blockCode:block.code]">
                <span class="name" style="top: 17px;left: 50px">${block.name}</span>
