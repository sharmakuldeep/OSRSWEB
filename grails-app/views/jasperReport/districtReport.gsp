...
<div style="border:2px solid #000000;height: 400px ">
    ...
    <div style="margin-left: 20px;font-size: 20px;">
        ...
        %{--<g:hasErrors bean="${userInstance}">
            ...
            <g:form controller="jasperReport" action="generateDistrictReport" name="myform" onsubmit="return validateFormDistrictReport(this)" >
            %{--<input type="hidden"  value="" id="stateCode">--}%
                <table>
                    ...
                    <tr>
                        ...
                        <td class="right">
                            <g:if test="${state}">
                                <select id="state" name="stateCode" style="height:25px" class="selectBox" disabled="disabled" >
                                   <option value="${state.code}">${state.name}</option>
                                </select>
                                <input type="hidden" name="state" value="${state.code}">
                            </g:if>
                            <g:elseif test="${!district && !block}">
                                <g:select  id="state" from="${states}" name="stateCode" value="" optionKey="code" optionValue="name"
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                           <input name="Submit" class="button" type="submit" value="Submit this Info"/></button>
                            %{--<input type="button" value="Submit" onclick="validateFormDistrictReport()">--}%
