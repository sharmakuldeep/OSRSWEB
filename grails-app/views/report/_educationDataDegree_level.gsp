...
<div style="width: 1000px;display: none;" id="educationDataDegree_level">
    ...
    <input type="button" value="Previous" onclick="eduPrevious('educationDataDegree_level','educationDataXI_XII');" style="float:left;"/>
                <input type="button" value="Next" onclick="eduNext('educationDataDegree_level','educationDataTech_course');" style="float:right"/>
