...
<div id="content">
    ...
    <font size='1' color='red'>
        ...
        <span class="graytitle">Health And Family Welfare: Others</span>
      <g:form controller="healthDataCollection" action="iSaveVitalStatisticsHealthData">
          <ul class="pageitem">

              <li class="smallfield"><span class="name" style="font-size: 15px;white-space:normal;line-height:20px;width: 70%">Beds For Women Nos</span>
              <input  placeholder="Enter Number" type="text" name="health39" style="width: 28%;font-size: 15px;" value="${healthFW?.health39}" onkeypress="validateIsNumber(event)" />
              </li>

              <li class="smallfield"><span class="name" style="font-size: 15px;white-space:normal;line-height:20px;width: 70%">ASHA-Workers Nos</span>
              <input  placeholder="Enter Number" type="text" name="health40" style="width: 28%;font-size: 15px;" value="${healthFW?.health40}" onkeypress="validateIsNumber(event)" />
              </li>
